...
-목적-
SimpleRNNCell을 2-layer로 구성하여 영화 리뷰가 긍정인지 부정인지 판별하는 모델 학습

-학습 결과-
훈련 데이터셋에 약 99%, 테스트 데이터셋에 약 78%의 성능을 보였다.
"""
import os
...
#RNNCell을 이용한 모델 정의
class RNN_by_cell(tensorflow.keras.Model):
    def __init__(self, units):
        super(RNN_by_cell, self).__init__()
        ...
        self.RNNCell0 = tensorflow.keras.layers.SimpleRNNCell(units=units, dropout=0.2)
        self.RNNCell1 = tensorflow.keras.layers.SimpleRNNCell(units=units, dropout=0.2)
